	...
	*/
	...
	_resolveTickFontOptions: function(index) {
		...
		return helpers$1.extend(helpers$1.options._parseFont({
			fontFamily: resolve$4([options.fontFamily], context),
			fontSize: resolve$4([options.fontSize], context),
			fontStyle: resolve$4([options.fontStyle], context),
			lineHeight: resolve$4([options.lineHeight], context)
		}), {
			color: resolve$4([options.fontColor, core_defaults.fontColor], context),
			lineWidth: resolve$4([options.lineWidth], context),
			strokeStyle: resolve$4([options.strokeStyle], context)
		});
	}
});
