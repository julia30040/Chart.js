...
helpers$1.extend(DatasetController.prototype, {
	...
	setHoverStyle: function(element) {
		...
		model.backgroundColor = resolve$1([custom.hoverBackgroundColor, dataset.hoverBackgroundColor, getHoverColor(model.backgroundColor)], undefined, index);
		model.borderColor = resolve$1([custom.hoverBorderColor, dataset.hoverBorderColor, getHoverColor(model.borderColor)], undefined, index);
		model.borderWidth = resolve$1([custom.hoverBorderWidth, dataset.hoverBorderWidth, model.borderWidth], undefined, index);
	},
...
var controller_line = core_datasetController.extend({
	...
	_resolveDatasetElementOptions: function(element) {
		...
		values.steppedLine = resolve$3([custom.steppedLine, config.steppedLine, lineOptions.stepped]);
	...
	*/
	...
	_resolveTickFontOptions(index) {
		...
		return helpers$1.extend(helpers$1.options._parseFont({
			...
			color: resolve([options.fontColor, core_defaults.fontColor], context),
